...
def test_mesmo_update(acq_func_mesmo):
    pass

'''
测试MESMOC
'''
def test_mesmoc_update(acq_func_mesmoc):
    pass

'''
测试MESMOC2
'''
def test_mesmoc2_update(acq_func_mesmoc2):
    pass

'''
测试Usemo
'''
def test_usemo_update(acq_func_usemo):
    pass

def test_acq_func_mc_ehvic(acq_func_mc_ehvic):
    pass

def test_acq_func_mc_parEGOC(acq_func_mc_parEGOC):
    pass

def test_mcei(acq_func_mcei):
    pass

def test_mceic(acq_func_mceic):
    pass
