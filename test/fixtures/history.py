...
@pytest.fixture
def history_single_obs_2(configspace_2):
    config_space = configspace_2
    # Create a History instance
    config1 = config_space.sample_configuration()
    config2 = config_space.sample_configuration()
    config3 = config_space.sample_configuration()
...
@pytest.fixture
def multi_start_history_double_obs(configspace_tiny):
    config_space = configspace_tiny
    # Create a History instance
    config1 = config_space.sample_configuration()
    config2 = config_space.sample_configuration()
    ...
    # Set up observations with different objective values
    observation1 = Observation(config=config1, objectives=[0.1,0.2], trial_state=SUCCESS)
    observation2 = Observation(config=config2, objectives=[0.3,0.4], trial_state=SUCCESS)
    observation3 = Observation(config=config3, objectives=[0.5,0.6], trial_state=SUCCESS)
    observation4 = Observation(config=config4, objectives=[2.0,0.3], trial_state=FAILED)
